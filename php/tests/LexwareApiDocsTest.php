 ...
 */
final class LexwareApiDocsTest extends TestCase
{
    ...
    private static function mountedRoutes(): array
    {
        ...
        $registry = new ModuleRegistry([new LexwareModule()]);
    ...
    public function testEveryEntryIsWellFormed(): void
    {
        $permissions = array_map(
            ...
            (new LexwareModule())->permissions(),
        );

        foreach ((new LexwareModule())->apiDocs() as $doc) {
